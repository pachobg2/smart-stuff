...
| [doorbell](https://github.com/pachobg2/doorbell) | ESP32-C3-Zero | Mains/USB-powered doorbell, WiFiManager setup portal, press modeled as an MQTT `event` entity | Public |
