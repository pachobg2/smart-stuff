...
| [doorbell](https://github.com/pachobg2/doorbell) | ESP32-C3-Zero | Battery-powered deep-sleep doorbell: wakes on the switch press, WiFiManager setup portal, press modeled as an MQTT `event` entity, LED color/on-time chosen from HA | Public |
